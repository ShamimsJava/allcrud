...
public final class display_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      com.shamim.bean.User user = null;
      synchronized (_jspx_page_context) {
        user = (com.shamim.bean.User) _jspx_page_context.getAttribute("user", PageContext.PAGE_SCOPE);
        if (user == null){
          user = new com.shamim.bean.User();
    ...
    request.setAttribute("list", list);
      ...
      out.write("    <body>\n");
      out.write("    <center>\n");
      out.write("        <h2>All users information</h2>\n");
      out.write("        <h3><a href=\"registration.jsp\">Add New Record</a></h3>\n");
      ...
      out.write("\n");
      out.write("        </table>\n");
      out.write("        <h3><a href=\"login.jsp\">Logout</a></h3>\n");
      out.write("    </center>\n");
      out.write("</body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {
